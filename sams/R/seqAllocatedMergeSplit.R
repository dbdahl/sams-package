...
#'   functionality for the two parameter CRP prior, as well as complementing these allocations with
#'   restricted Gibbs scans such as those discussed in Jain & Neal (2004).
#'
